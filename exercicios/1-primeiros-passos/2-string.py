resumo = "Werlis Junior é um homem de 34 anos que deseja mudar de profissão, por isso está estudando 'python'."
...
# Imprima na tela a idade de Werlis Junior (resposta esperada: "34")
idade = 34
print(idade)
...
print(f"Werlis Junior é um homem de {idade} anos que deseja mudar de profissão, por isso está estudando 'python'.")
